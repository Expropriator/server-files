    ...
    class ATM : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                {
                    //if(!ignoreAtmIndex.Contains(i)) NAPI.Blip.CreateBlip(500, ATMs[i], 0.20f, 27, "Банкомат", shortRange: true, dimension: 0);
                    // Создаем blip для каждого банкомата
                    NAPI.Blip.CreateBlip(500, ATMs[i], 0.75f, 2, "ATM", shortRange: true, dimension: 0);
