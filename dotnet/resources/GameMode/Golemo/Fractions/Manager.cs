...
namespace Golemo.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(590, new Vector3(-598.3013, -929.97565, 22.743652), 0.8f, 1, Main.StringToU16("Weazel News"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(419, Cityhall.CityhallChecksCoords[2], 0.95f, 4, Main.StringToU16("Government"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(60, new Vector3(2578.9368, -294.99316, 92.281494), 0.8f, 39, Main.StringToU16("Federal Investigation Buerau"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(60, new Vector3(435.1756, -981.82, 29.56958), 0.8f, 3, Main.StringToU16("Los Santos Police Department"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(269, new Vector3(-2305.0386, 3388.69, 30.136518), 0.9f, 4, Main.StringToU16("San Andreas National Guard"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(455, Army.ArmyCheckpoints[2], 0.8f, 17, Main.StringToU16("Порт"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(60, Manager.FractionSpawns[18], 0.8f, 1, Main.StringToU16("Blaine County Sheriff Department"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(543, Manager.FractionSpawns[1], 0.8f, 2, Main.StringToU16("Groove Street"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(543, Manager.FractionSpawns[2], 0.8f, 7, Main.StringToU16("The Ballas Gang"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(543, Manager.FractionSpawns[3], 0.8f, 5, Main.StringToU16("Los Santos Vagos"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(543, Manager.FractionSpawns[4], 0.8f, 3, Main.StringToU16("The Crips Gang"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(543, Manager.FractionSpawns[5], 0.8f, 1, Main.StringToU16("The Bloods Gang"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[10], 0.8f, 5, Main.StringToU16("La Cosa Nostra"), 255, 0, true, 0, 0);
                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[11], 0.8f, 39, Main.StringToU16("Russian Mafia"), 255, 0, true, 0, 0);
                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[12], 0.8f, 4, Main.StringToU16("Yakuza"), 255, 0, true, 0, 0);
                //NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[13], 0.8f, 76, Main.StringToU16("Armenian Mafia"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(480, new Vector3(-495.14215, -684.2896, 32.09113), 0.6f, 5, Main.StringToU16("Тревор"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(480, new Vector3(694.5975, 252.09875, 92.35306), 0.6f, 57, Main.StringToU16("Джон"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(467, new Vector3(-1247.8358, -1473.2466, 3.1403518), 0.9f, 10, Main.StringToU16("Рынок"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(535, new Vector3(-117.353905, -604.39935, 35.160725), 0.8f, 3, Main.StringToU16("Arcadius"), 255, 0, true, 0, 0);
        ...
        {
            {1, new Vector3(-242.12613, -1492.8114, 32.934348)},    // The Families
            {2, new Vector3(-84.15844, -1804.0552, 33.628383)},     // The Ballas Gang
            {3, new Vector3(967.7381, -1851.8191, 31.283015)},     // Los Santos Vagos
            {4, new Vector3(1445.1412, -1486.5995, 66.525436)},     // Marabunta Grande
            {5, new Vector3(480.2532, -1324.6538, 29.207103)},     // Blood Street
            {6, new Vector3(-582.47003, -175.04378, 37.809097)},      // Cityhall
            {7, new Vector3(441.36044, -1017.68195, 28.346472)},      // LSPD police
            {8, new Vector3(284.6194, -604.89246, 46.606995)},      // Emergency care
            {9, new Vector3(151.81834, -751.9338, 242.13195)},     // FBI 
            {10, new Vector3(-1897.5502, 2049.5825, 140.45679)},     // La Cosa Nostra 
            {11, new Vector3(-1346.84, 69.60607, 60.501582)},    // Russian Mafia
            {12, new Vector3(-1060.9486, 308.34747, 65.939606)},    // Мексиканская мафия
            {13, new Vector3(-1540.5802, 120.45402, 57.391727)},    // Armenian Mafia 
            {14, new Vector3(-2339.0493, 3261.2566, 33.294193)},    // Army
            {15, new Vector3(-595.9326, -929.87, 22.695719)},    // LSNews
            {16, new Vector3(944.8635, 6.0115, 74.7413)},    // NamanaBet
            {17, new Vector3(905.4962, -3200.6926, -97.10795)},    // Меривейзер
			{18, new Vector3(-454.6883, 6014.8755, 31.596548)}, // шериф шадоу
            {19, new Vector3(1788.8773, 2547.2007, 44.677956)},    // Tюрьма
        };
        ...
        [RemoteEvent("SetFracClothes")]
        public static void ClothesFractions(Player player, string id)
        {
            ...
            if (gender)
            {
                ...
                else if (Main.Players[player].FractionID == 8)
                {
                    switch (id)
                    {
            ...
            if (gender)
            {
                switch (clothes)
                {
                    ...
                    case "city_9":
                        ...
                        break;
                    case "police_1":
                        player.SetClothes(11, 399, 0);
                        player.SetClothes(4, 130, 1);
                        player.SetClothes(6, 7, 2);
                        player.SetClothes(8, 192, 0);
                        player.SetClothes(3, 171, 0);
                        player.SetClothes(7, 165, 0);
                        break;
                    case "police_2":
                        player.SetClothes(11, 399, 0);
                        player.SetClothes(4, 130, 1);
                        ...
                        break;
                    case "police_3":
                        player.SetClothes(1, 101, 9);
                        player.SetClothes(11, 406, 2);
                        player.SetClothes(4, 130, 1);
                        player.SetClothes(6, 7, 2);
                        player.SetClothes(8, 200, 0);
                        player.SetClothes(3, 171, 0);
                        break;
                    case "police_4":
                        player.SetClothes(1, 101, 9);
                    ...
                    case "police_7":
                        ...
                        break;
                    case "police_8":
                        player.SetClothes(11, 25, 4);
                        player.SetClothes(8, 22, 4);
                        player.SetClothes(4, 24, 0);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(7, 161, 0);
                        player.SetClothes(3, 1, 0);
                        player.SetClothes(1, 101, 9);
                        break;
                    case "police_9":
                        player.SetClothes(11, 322, 0);
                        player.SetClothes(7, 160, 0);
                        player.SetClothes(8, 185, 0);
                        player.SetClothes(4, 28, 0);
                        player.SetClothes(6, 7, 0);
                        player.SetClothes(3, 4, 0);
                        player.SetClothes(1, 101, 9);
                        break;
                    case "fib_1":
                        player.SetClothes(11, 399, 2);
                        player.SetClothes(3, 0, 0);
                        player.SetClothes(4, 24, 1);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(1, 121, 0);
                        break;
                    case "fib_2":
                        player.SetClothes(11, 404, 1);
                        player.SetClothes(9, 54, 0);
                        player.SetClothes(8, 160, 0);
                        player.SetClothes(7, 27, 2);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(4, 24, 0);
                        player.SetClothes(3, 22, 0);
                        player.SetClothes(1, 121, 0);
                        break;
                    case "fib_3":
                        player.SetClothes(11, 404, 1);
                    ...
                    case "fib_7":
                        ...
                        player.SetClothes(4, 24, 0);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(7, 25, 2);
                        player.SetClothes(8, 33, 0);
                        player.SetClothes(9, 53, 0);
                        player.SetClothes(1, 121, 0);
                        break;
                    case "fib_8":
                        player.SetClothes(11, 192, 5);
                        player.SetClothes(3, 22, 0);
                        player.SetClothes(4, 24, 0);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(1, 121, 0);
                    ...
                    case "fib_9":
                        ...
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(1, 121, 0);
                        player.SetClothes(8, 96, 2);
                        player.SetClothes(9, 53, 0);
                        player.SetClothes(7, 38, 0);
                        break;
                    case "fib_10":
                        player.SetClothes(11, 31, 1);
                        player.SetClothes(3, 22, 0);
                        player.SetClothes(4, 24, 1);
                        player.SetClothes(6, 10, 0);
                        player.SetClothes(1, 121, 0);
        ...
        public static void giveGun(Player player, Weapons.Hash gun, string weaponstr)
        {
            ...
            if (Main.Players[player].FractionID == 19) minutes = 10;
        ...
        public static void OpenFractionMenu(Player player)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "openfm", FractionNames[Main.Players[player].FractionID], JsonConvert.SerializeObject(FracLogs[Main.Players[player].FractionID]), JsonConvert.SerializeObject(Names), Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Materials, Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Drugs, Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Medkits, Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Money);
            }
            catch (Exception e) { Log.Write("EXCEPTION AT \"OPENFMENU\":\n" + e.ToString(), nLog.Type.Error); }
        }
        [RemoteEvent("fmenuputmoney")]
        public static void putmoneyFrac(Player player, int money)
        {
            if (money == 0) return;
            if (Main.Players[player].FractionID == 0) return;
            if (Main.Players[player].FractionLVL < 8) return;
            if (money > 0)
            {
                if (Main.Players[player].Money < money)
                {
                    Notify.Succ(player, $"Недостаточно денег");
                    return;
                }
                Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Money += money;
                Fractions.Stocks.fracStocks[Main.Players[player].FractionID].UpdateLabel();
                Notify.Succ(player, $"Вы положили {money}$ в свою фракцию");
                MoneySystem.Wallet.Change(player, -money);
            }
        }

        [RemoteEvent("fmenutakemoney")]
        public static void takemoneyFrac(Player player, int money)
        {
            if (money == 0) return;
            if (Main.Players[player].FractionID == 0) return;
            if (Main.Players[player].FractionLVL < 8) return;
            if (money > 0)
            {
                if (Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Money < money)
                {
                    Notify.Succ(player, $"Недостаточно денег на счете фракции");
                    return;
                }
                Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Money -= money;
                Fractions.Stocks.fracStocks[Main.Players[player].FractionID].UpdateLabel();
                Notify.Succ(player, $"Вы сняли {money}$ со своей фракции");
                MoneySystem.Wallet.Change(player, money);
            }
        }
        [RemoteEvent("fmenu")]
                    ...
                    case 5:
                        {
                            ...
                            List<string> Names = JsonConvert.DeserializeObject<List<string>>(data1);
                            ...
                            {
                                if (Names[ranki.Key] == null) continue;
                                Log.Write($"{ranki.Key} | {Names[ranki.Key]}");
                                Tuple<string, string, string, int> old = ranki.Value;
                                Tuple<string, string, string, int> newR = new Tuple<string, string, string, int>(Names[ranki.Key], old.Item2, old.Item3, old.Item4);
                                NEWRanks.Add(ranki.Key, newR);
                                MySQL.Query($"UPDATE fractionranks SET name='{Names[ranki.Key]}' WHERE fraction={Main.Players[player].FractionID} AND rank={ranki.Key}");


                            }

                            Configs.FractionRanks[Main.Players[player].FractionID] = NEWRanks;
    ...
    class Stocks : Script
    {
        ...
        {
            { 1, new Vector3(-27.466484, -1396.8997, -1000)},    // The Families
            { 2, new Vector3(-78.703186, -1810.9852, -1009.675596)},     // The Ballas Gang
            { 3, new Vector3(811.9526, -2312.2295, 29.344728)},     // Los Santos Vagos
            { 4, new Vector3(1373.4705, -2095.4429, 47.48425)},     // Marabunta Grande
            { 5, new Vector3(940.8616, -1529.4573, 29.974173)},     // Blood Street
            { 6, new Vector3()},
            { 7, new Vector3()},
            { 8, new Vector3()},
            { 9, new Vector3()},
            { 10, new Vector3(-1866.2694, 2061.3909, 134.31445)},
            { 11, new Vector3(-1356.9578, 130.09908, 55.11875)}, // 234.63676
            { 12, new Vector3(-1050.8527, 308.61127, 61.097157)},//48.93244
            { 13, new Vector3(-1518.2844, 112.15461, 48.92718)},
            { 14, new Vector3()},
            { 15, new Vector3(-1055.0615, -231.2893, 43.201)},
        ...
        {
            { 1, new Vector3(-256.16415, -1546.7535, 30.557762)},
            { 2, new Vector3(-130.67259, -1777.9348, 28.70222)},
            { 3, new Vector3(859.64825, -2363.8542, 29.226114)},
            { 4, new Vector3(1359.7496, -2095.6743, 50.876274)},
            { 5, new Vector3(946.94604, -1575.505, 29.230757)},
            ...
            { 9, new Vector3(98.27156, -722.16394, 32.0132)},
            { 10, new Vector3(-1922.45, 2067.998, 139.31883)},
            { 11, new Vector3(-125.01851, 1008.9969, 234.60822)}, //235.6121
            { 12, new Vector3(-1062.3923, 300.50934, 64.79571)}, //55.54241
            { 13, new Vector3(-1534.1029, 80.95463, 55.654095)},
            { 14, new Vector3(-2455.718, 2984.414, 31.81033)},
            { 15, new Vector3()},
            { 16, new Vector3(977.316, -133.0648, 72.66093)},
            { 17, new Vector3(175.78754, -30325.2566, -4.6541348)}, //убрать минус
             { 18, new Vector3(-447.6798, 5993.688, 29.22054)}, // Sheriff 
             { 19, new Vector3(1628.2402, 2621.1638, 43.63685)}, // Prison 
        };
        ...
        public void fillStocks()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    NAPI.Marker.CreateMarker(1, stockCoords[id] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(67, 140, 239, 220));
        ...
        public static void Event_openWeaponsStock(Player player)
        {
            try
            {
                ...
                GUI.Dashboard.OpenOut(player, fracStocks[(int)player.GetData<int>("ONFRACSTOCK")].Weapons, "Склад оружия", 6);
            }
