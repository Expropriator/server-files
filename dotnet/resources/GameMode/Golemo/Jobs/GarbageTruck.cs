...
namespace Golemo.Jobs
{
    class GarbageTruck : Script
    {
        ...
        private static ColShape GarbageShape;
        ...
        public static void GarbageTruckStartWork(Player player)
        {
            ...
            GarbageShape = NAPI.ColShape.CreateCylinderColShape(new Vector3(-2.3895, 8.5629, 2),2, 1, 0); // Добавлен новый shape
            GarbageShape.SetData("NAME", "Garbage");
        }
