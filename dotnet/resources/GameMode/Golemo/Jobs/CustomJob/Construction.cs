...
namespace Golemo.Jobs.CustomJob
{
    class Construction : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(566, new Vector3(145.0445, -373.0724, 42.54742), 1, 46, Main.StringToU16("Строитель"), 255, 0, true, 0, 0); // Блип на карте
                NAPI.TextLabel.CreateTextLabel("~w~Приму вас на работу", new Vector3(144.8581, -373.5612, 44.54737), 30f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension); // Над головой у бота
