...
namespace Golemo.VehicleHandlers
{
    public static class VehiclesName
    {
        ...
        public static Dictionary<VehicleHash, string> ModelList2 = new Dictionary<VehicleHash, string>()
        {
              ...
              { (VehicleHash)NAPI.Util.GetHashKey("g63"), "Mercedes-Benz G63" },
              { (VehicleHash)NAPI.Util.GetHashKey("gle63"), "Mercedes-Benz GLE 63" },
              { (VehicleHash)NAPI.Util.GetHashKey("18rs7"), "Audi RS7 2018" },
              { (VehicleHash)NAPI.Util.GetHashKey("m5comp"), "BMW M5 Competition" },
              { (VehicleHash)NAPI.Util.GetHashKey("modelx"), "Tesla Model X" },
              { (VehicleHash)NAPI.Util.GetHashKey("taycan21"), "Porsche Taycan Litvin Edition" },
              //modelname  //Realname
        };
    }
}
